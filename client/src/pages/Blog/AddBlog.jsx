...
const AddBlog = () => {
  ...
  async function onSubmit(values) {
    try {
      ...
      setTimeout(() => navigate(RouteBlog), 2000);
    } catch (error) {
                ...
                >
                  {({ getRootProps, getInputProps }) => (
                    <div {...getRootProps()} className="cursor-pointer">
                      <input {...getInputProps()} />
                      <div className="flex flex-col justify-center items-center w-40 h-32 border-2 border-dashed border-violet-400 bg-white rounded-lg transition hover:bg-gray-200">
                        {filePreview ? (
                          <img
                            src={filePreview}
                          ...
                          <>
                            <svg
                              ...
                              className="h-10 w-10 text-violet-400 mb-2"
                              fill="none"
                              viewBox="0 0 24 24"
                              stroke="currentColor"
                            >
