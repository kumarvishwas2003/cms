  ...
  return (
    <div className="flex justify-between items-center h-16 fixed w-full z-30 bg-white/80 backdrop-blur-lg px-8 border-b border-violet-100 shadow-md rounded-b-2xl">
      ...
      <div className="w-[500px]">
        <div
          className={`md:relative md:block absolute bg-white/80 rounded-lg shadow-sm left-0 w-full md:top-0 top-16 md:p-0 p-5 ${
        ...
        {!user.isLoggedIn ? (
          ...
          <DropdownMenu>
            <DropdownMenuTrigger className="focus:outline-none">
              <Avatar className="ring-2 ring-violet-200 hover:ring-violet-400 transition-all">
